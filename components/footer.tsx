        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-foreground-muted">
              &copy; {new Date().getFullYear()} Cedric Matyja
            </span>
          </div>

          <div className="flex items-center gap-6">
            <a
              href="mailto:contact@cajytam.fr"
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.955 13.587l-1.342-4.135-2.664-8.189c-.135-.423-.73-.423-.867 0l-2.664 8.189H7.583L4.919 1.263c-.135-.423-.731-.423-.867 0L1.388 9.452.046 13.587c-.097.299.022.628.28.816L12 22.654l11.674-8.251c.258-.188.377-.517.281-.816z" />
                </svg>
              </a>
            </div>
          </div>
